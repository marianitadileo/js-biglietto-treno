...
if(ageUser < 18) {
    ...
    document.getElementById('price').innerHTML = "Buone notizie! Avete ricevuto uno sconto del 20%. Il costo del biglietto sarà " + reducedPrice + "€";
} else if (ageUser > 65) {
    discountOver = 0.4;
    reducedPrice = priceJourney - discountOver;
    reducedPrice = reducedPrice.toFixed(2); 
    console.log(reducedPrice);
    document.getElementById('price').innerHTML = "Buone notizie! Avete ricevuto uno sconto del 40%. Il costo del biglietto sarà " + reducedPrice + "€";
} else {
